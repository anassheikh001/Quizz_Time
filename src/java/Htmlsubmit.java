...
public class Htmlsubmit extends GenericServlet {
    public void service(ServletRequest rq, ServletResponse rs) 
    {
        try {
            ...
            if (rq.getParameter("q1") != null && rq.getParameter("q1").equals("HyperText Markup Language")) {
                c++;
            }
            if (rq.getParameter("q2") != null && rq.getParameter("q2").equals("HTML, Head, Title, Body")) {
                c++;
            }
            if (rq.getParameter("q3") != null && rq.getParameter("q3").equals("HTML 5")) {
                c++;
            }
            if (rq.getParameter("q4") != null && rq.getParameter("q4").equals("'src'")) {
                c++;
            }
            if (rq.getParameter("q5") != null && rq.getParameter("q5").equals("Tim Berners-Lee")) {
                c++;
            }
